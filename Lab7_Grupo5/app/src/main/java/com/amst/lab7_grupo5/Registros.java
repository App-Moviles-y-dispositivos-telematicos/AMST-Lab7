...
public class Registros extends AppCompatActivity {
    ...
    private void actualizarGrafico(JSONArray temperaturas){
        ...
        try
        {
            for (int i = 0; i < temperaturas.length(); i++) { registro_temp = (JSONObject) temperaturas.get(i);
                if( registro_temp.getString("key").equals("temperatura")){
                    ...
                    dato_temp.add(new BarEntry(count, temp_val)); count++;
                } }
    ...
    private void llenarGrafico(ArrayList<BarEntry> dato_temp){
        ...
        if ( graficoBarras.getData() != null &&
            ...
            temperaturasDataSet.setValues(dato_temp); graficoBarras.getData().notifyDataChanged();
